...
class Hooks::LeadsController < WebhookController
  ALLOWED_PARAMS = {
    ...
    dob_day: 'DOB day - string - REQUIRED if dob is blank',
    dob_month: 'DOB month - string - REQUIRED if dob is blank',
    dob_year: 'DOB year - string - REQUIRED if dob is blank',
    ...
    utm_ad_platform: 'UTM Ad Platform - string',
